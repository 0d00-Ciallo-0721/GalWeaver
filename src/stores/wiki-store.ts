...
interface WikiState {
  ...
  activeView: "wiki" | "sources" | "search" | "graph" | "lint" | "soul" | "dismantling" | "bookAnalysis" | "settings" | "trash" | "reviewCenter" | "gal"
  ...
  setGalMode: (galMode: boolean) => void
...
export const useWikiStore = create<WikiState>((set) => ({
  ...
  setGalMode: (galMode) => set({ galMode }),
