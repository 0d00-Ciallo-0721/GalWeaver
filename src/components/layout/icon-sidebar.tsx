import {
  FileText, FolderOpen, Search, Network, Brain, Settings, ArrowLeftRight, Sun, Moon, Monitor, Trash2, Sparkles, LayoutDashboard, BookOpen, Heart,
} from "lucide-react"
...
const NAV_ITEMS: { view: NavView; icon: typeof FileText; labelKey: string; novelLabelKey: string }[] = [
  ...
  { view: "gal", icon: Heart, labelKey: "nav.gal", novelLabelKey: "novel.nav.gal" },
