...
async function buildContextPackFromRawData(
  ...
  // 构建修订指令（Gal 初始化时可能无修订数据）
  const revisionDirectives = buildRevisionDirectives(rawData.revisionFeedback ?? { mustFix: [], shouldImprove: [], carryToNextChapter: [] })
